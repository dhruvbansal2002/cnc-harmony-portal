...
import { createEmptyCustomerFormValues } from '../../lib/customers'
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            onChange={(event) =>
              setValues((current) => ({ ...current, character_name: event.target.value }))
            }
        ...
        <label className="block">
          ...
          <select
            ...
            onChange={(event) =>
              setValues((current) => ({
                ...current,
                status: event.target.value as CustomerFormValues['status'],
              }))
            }
            value={values.status}
          >
